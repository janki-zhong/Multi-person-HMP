...
class Recurrent_block(nn.Module):
    def __init__(self, D:int, D_rnn:int=...,
        ...
        # self.rglru = RGLRU(self.D_rnn, expansion_factor=1)
        self.attn = Attention(self.D_rnn, num_heads=16, qkv_bias=True, qk_scale=0.6, proj_drop=0.2)
        # self.attn = Attention_se(self.D_rnn, proj_drop=0.2)
    ...
    def forward(self, x:Tensor) -> Tensor:
        ...
        # x2 = self.rglru(x2)
        x2 = self.attn(x2)  # x2  self.attn隐藏层为D_rnn
